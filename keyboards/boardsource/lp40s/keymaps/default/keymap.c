...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MAIN] = LAYOUT(
    ...
    RGB_SAI,    RGB_SAD,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
    RGB_HUI,  RGB_HUD, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,  KC_UP, KC_ENT ,
    RGB_MOD, RGB_TOG, RGB_M_P,   LOWER,   KC_SPC,   KC_SPC,   RAISE,  KC_LEFT,   KC_DOWN, KC_RIGHT
  ),
